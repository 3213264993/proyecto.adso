...
class ConectorBd{
    ...
    public function __construct(){
        $this->conexion = new mysqli($this->servidor,$this->usuarioBd,$this->claveBd,
        $this->baseDatos);
        ...
        //linea de codigo para borar
        else {
            echo"si hay conexion";
        }
        
    }
     public function consultassinretorno($cadenaSql)//insert delete update
     {
        $this->conexion->query($cadenaSql);
     }

     public function consultasconretorno($cadenaSql)//select
     {
